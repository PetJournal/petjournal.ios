                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    ScrollView {
                        VStack(spacing: 16) {
                            ...
                            AutoCompleteSelect(selectedItem: $viewModel.size, items: viewModel.getSize(), placeholder: "Qual o porte?")
                            ...
                            AutoCompleteSelect(selectedItem: $viewModel.type, items: viewModel.getAnimalType(), placeholder: "Qual o tipo do animal?")
