    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                Spacer()
                VStack(spacing: 10) {
                    CustomTextField(isPasswordVisible: $isPasswordPrimary, text: $viewModel.user.password, placeholder: "Your password", prompt: "", title: "Nova Senha")
                    
                    CustomTextField(isPasswordVisible: $isPasswordSecudary, text: $viewModel.user.passwordMatch, placeholder: "Repeat your password", prompt: "Error", title: "Confirme nova senha")
                }
